 ...
 * Export data.
 */
function exportDataV2({ slug, search, applySearch, deepness = 5 }) {
    return __awaiter(this, void 0, void 0, function* () {
        const slugsToExport = slug === constants_1.CustomSlugs.WHOLE_DB ? (0, models_1.getAllSlugs)() : (0, arrays_1.toArray)(constants_1.CustomSlugToSlug[slug] || slug);
        let store = {};
